...
pub struct ProposalDossier {
    ...
    pub rationale: String,
    /// Self-reported classification of the body rewrite the agent did at
    /// proposal time. One of `none`, `light_edit`, `full_synthesis`. Used
    /// for audit + downstream sharpening signal.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub body_rewrite_kind: Option<String>,
    /// True when a structured decision section was prepended to the page body.
    #[serde(default)]
    pub decision_section_present: bool,
}
