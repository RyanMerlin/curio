...
pub enum Commands {
    ...
    Doctor {
        /// Restrict scan to a NORTHSTAR path (e.g. product-tree/example-server).
        /// Defaults to the full published KB.
        #[arg(long)]
        scope: Option<String>,

        /// Emit review artifacts for high-value doctor findings.
        #[arg(long)]
        emit_review: bool,
    },
    ...
    Process {
        ...
        /// Category path for manual routing (e.g. "product-tree/example-server").
        #[arg(long)]
    ...
    Publish {
        ...
        /// Bypass the publish-time re-gate (quality / overlap / proposal-ready
        /// checks). Use ONLY when an operator has manually reviewed and
        /// approved publication. Logged loudly in audit + wiki/_admin/log.md.
        #[arg(long)]
        force: bool,
    },
    ...
    Sync {
        ...
        /// Sync docs and structure only; skip downloadable bundle generation.
        #[arg(long)]
        docs_only: bool,

        /// Sync downloadable bundles only; skip content page updates.
        #[arg(long)]
        downloads_only: bool,
    },
    ...
    ///   curio heal --prepare --scope product-tree/example-server --out /tmp/heal.json
    ...
    Heal {
        ...
        /// NORTHSTAR scope path (e.g. product-tree/example-server).
        ...
        /// Override confidence threshold from _admin/config.yaml for this run.
