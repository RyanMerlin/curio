...
confidence: null
cross_refs: []
content_hash: sha256:f7b47998b8222283ad1027be460ea2cd159de646b32b19354a0474e181d1765b
...
| Request logs to review. | Logs and Traces and [How To: Attach Server Log Files](https://alteryx.lightning.force.com/kA02R0000000veISAQ) - Know which logs to request depending on the customer issue. Be sure to request logs at outset of case ownership during initial response. |
...
| Legacy Scheduler Options > View Schedules | If you’re seeing a job fail with a generic error, it can sometimes help to view the job output from the legacy scheduler from Designer on the Server/Controller machine. |
