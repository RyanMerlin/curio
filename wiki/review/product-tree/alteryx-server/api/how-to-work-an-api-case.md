...
confidence: 0.85
cross_refs: []
content_hash: sha256:5602bee489559048a37483e97f854d16d866a42935c074ff9424ad19a7dc5266
...
| Where are you making the call from? | This is more informational.  If they are using the V3 API Pack, you can test that on your APOD.  Get API pack in Introducing the Alteryx Server v3 API (899228). |
...
| Check | Steps |
| --- | --- |
| API’s Confluence page | Known issues or nuances with specific API endpoints are listed here.Endpoints > V3 > V2 > V1 |
