...
updated_at: 2026-04-14T13:50:39Z
confidence: 0.87
cross_refs: []
content_hash: sha256:0fead09492ea702815557c72d531c48bc091b2021b5faea8da33f0f54133e75a
...
| Key Articles | Alteryx Server Backup and Recovery Part 2: Procedures (KB)                                   <== includes PowerShell script ot automate backups |
| --- | --- |
| Restore | #E3FCEFX:cd \FOLDER\Alteryx\binnet stop alteryxserviceAlteryxService.exe emongorestore=”X:\BKP”,”X:\REST”,10,10 is not needed in modern versions of Server (24+).  It was used to minimize memory use as large restore could blow out memory.  Newer versions of MongoDB manage memory better w/o the need for .10. |
| Log | In the restore folderA quick scan will review any exceptions thrown during the restore as they appear with very different formatting (lots of whitespace and indented sections). |
