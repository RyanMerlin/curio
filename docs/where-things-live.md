...
- Confluence bootstrap docs and structural pages (`README`, `Admin`, `Intake`, `Staged`, `Review`, `Published`)
...
- `wiki/NORTHSTAR.md` — prose charter for the active Curio instance
- `wiki/_admin/` — `config.yaml` (taxonomy + runtime settings), `log.md` (audit log)
